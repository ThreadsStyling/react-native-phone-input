...
export default class PhoneInput extends Component {
  ...
  getflagAndFormatNumber(num = this.props.value) {
    ...
    return { iso2, formattedNumber: phoneNumber }
  }

  updateFlagAndFormatNumber(num, actionAfterSetState = null) {
    this.setState(this.getflagAndFormatNumber(num), actionAfterSetState);
  }
